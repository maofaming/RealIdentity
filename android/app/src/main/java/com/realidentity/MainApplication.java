...
import com.realidentity.ali.RealIdentityPackage;
...
public class MainApplication extends Application implements ReactApplication {
      ...
      new ReactNativeHost(this) {
        ...
        protected List<ReactPackage> getPackages() {
          ...
          // packages.add(new MyReactNativePackage());
            packages.add(new RealIdentityPackage());
          return packages;
        }
  ...
  public void onCreate() {
    ...
    initializeFlipper(this, getReactNativeHost().getReactInstanceManager());
      ...
      // 初始化实人认证SDK。
      CloudRealIdentityTrigger.initialize(appContext, true, buildALBiometricsConfig());//CloudRealIdentityTrigger
  }
  ...
  private static void initializeFlipper(
    ...
    if (BuildConfig.DEBUG) {
      try {
        ...
        */
        Class<?> aClass = Class.forName("com.realidentity.ReactNativeFlipper");
        aClass
